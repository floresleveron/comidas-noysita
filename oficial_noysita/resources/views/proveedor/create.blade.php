        ...
        <div class="card card-primary">
          ...
          <div class="col-6">
            <div class="form-group">
                ...
                <input type="number" class="form-control" id="celular_proveedor" name="celular_proveedor" placeholder=""value="{{old('celular_proveedor')}}">
        ...
        <div class="row">
          <div class="col-6">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="producto_venta" name="producto_venta" placeholder="" value="{{old('producto_venta')}}">
        ...
        <div class="row">
          <div class="col-6">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="ciudad_proveedor" name="ciudad_proveedor" placeholder="" value="{{old('ciudad_proveedor')}}">
          ...
          <div class="col-6">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="observacion" name="observacion" placeholder="" value="{{old('observacion')}}">
                @error('observacion')
                <span class="text-danger">{{$message}}</span>
                @enderror
              </div>
