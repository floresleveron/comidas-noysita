        ...
        <div class="row">
          ...
          <div class="col-6">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="categoria_producto" name="categoria_producto" placeholder="" value="{{old('categoria_producto')}}">
        ...
        <div class="row">
          ...
          <div class="col-6">
            <div class="form-group">
                ...
                <input type="number" class="form-control" id="maximo_producto" name="maximo_producto" placeholder="" value="{{old('maximo_producto')}}">
          ...
          <div class="col-6">
            <div class="form-group">
                ...
                <input type="number" class="form-control" id="minimo_producto" name="minimo_producto" placeholder="" value="{{old('minimo_producto')}}">
