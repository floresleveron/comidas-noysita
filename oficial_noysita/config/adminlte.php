...
return [
    ...
    */
    ...
    'preloader' => [
        'enabled' => true,
        'img' => [
            'path' => 'vendor/adminlte/dist/img/noysita.jpg',
    ...
    'menu' => [
        ...
        [
         ...
         [
            ...
            'submenu' => [
                [
                    'text' => ' Creacion de Factura',
                    'route'  => 'factura.index',
                ],
            ],
        ],
        ['header' => 'ADMINISTRACION DE SISTEMA'],
         //modulos Bitacora
